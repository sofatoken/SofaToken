...
/*
    Sofa Token - Community Charity Token
    
    - Every day the community chooses what the charity the charity-wallet-earnings go to,
    join telegram if you want to be a part of that.
    
    https://t.me/sofatoken
    
    2% of every transacion is converted to BNB and sent to the charity wallet
...
contract SofaToken is Context, IERC20, Ownable {
    ...
    string private _name = "Sofa Token";
    string private _symbol = "SOFA";
    ...
    address payable public charityAddress = 0xB0743a946b41FDBF4E456951fbAE7c48136e81A0; // Charity Wallet Address
